...
export class LinkWalletDto {
  ...
  @ApiProperty({
    description: 'SIWE message used to prove wallet ownership',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: 'SIWE signature for the wallet-link message',
    required: false,
  })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({
    description: 'Make the verified wallet primary',
    required: false,
  })
  @IsOptional()
  @IsBoolean()
